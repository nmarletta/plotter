...
void displayPlot(const char* filename, int selected, float progress, bool paused, bool confirmCancel, bool error = false, bool resetting = false, int8_t alarmCode = 0, const char* pauseReason = nullptr);
